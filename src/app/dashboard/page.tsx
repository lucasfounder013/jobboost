                  ...
                  <section id="historique">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                      {analysesRecentes.map((a) => (
                        <div key={a.id} className="bg-white rounded-2xl ring-1 ring-gray-200 shadow-sm p-5 flex flex-col gap-3">
                          ...
                          {a.cv_adapte_id && (
                            <button
                              onClick={() => { const cv = cvsAdaptes.find((c) => c.id === a.cv_adapte_id); if (cv) setCvOuvert(cv); }}
