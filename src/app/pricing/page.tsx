...
function PlanCard({
  ...
  return (
    <div className={`relative bg-white rounded-2xl shadow-sm p-8 flex flex-col gap-6 ${
      recommande ? "ring-2 ring-indigo-500" : "ring-1 ring-gray-200"
    }`}>
      {recommande && (
      ...
      <button
        ...
        className={`w-full py-3 rounded-xl font-bold text-sm transition-all disabled:opacity-60 disabled:cursor-not-allowed ${
          recommande
            ? "bg-gradient-to-r from-indigo-500 to-violet-500 text-white hover:opacity-90 shadow-md shadow-indigo-100"
        ...
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-3 text-sm">
            {session ? (
              ...
              <>
                <Link href="/login" className="text-gray-500 hover:text-gray-900 font-medium transition-colors">
                  Connexion
                </Link>
                <Link
                  href="/register"
      ...
      <main className="flex-1 bg-gradient-to-b from-blue-50 to-white">
        <section className="max-w-4xl mx-auto px-6 py-20 text-center">
          ...
          <p className="text-gray-500 text-lg max-w-md mx-auto mb-12">
            Analyses et adaptations CV illimitées. Annulez à tout moment.
          </p>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
            <PlanCard plan="hebdo" label="Hebdomadaire" prix="4,99€" periode="semaine" />
            <PlanCard plan="mensuel" label="Mensuel" prix="9,99€" periode="mois" recommande />
          </div>
            ...
            {[
              {
                ...
                r: "Oui, vous pouvez annuler votre abonnement à tout moment depuis votre espace Stripe. L'accès reste actif jusqu'à la fin de la période en cours.",
              },
              {
                q: "Les 5 analyses gratuites sont-elles renouvelées ?",
                r: "Non, les analyses gratuites sont données une seule fois à l'inscription. Un abonnement donne accès à des analyses illimitées.",
              },
              {
