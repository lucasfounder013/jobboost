...
export const metadata = {
  title: "Mots-clés CV Chargé RH : liste complète 2026 | JobBoost",
  description:
  ...
  ...ogMeta(
    "Mots-clés CV Chargé RH : liste complète 2026 | JobBoost",
    "Découvrez les 30+ mots-clés indispensables pour un CV Chargé RH qui passe les filtres ATS en 2026. Liste complète par catégorie + exemples.",
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      <main className="flex-1 max-w-6xl mx-auto w-full px-6 py-12">
        ...
        <ArticleJsonLd
          titre="Mots-clés CV Chargé RH : liste complète 2026 | JobBoost"
        ...
        <div className="lg:grid lg:grid-cols-[1fr_300px] lg:gap-16 lg:items-start">
          ...
          <article>
            ...
            <h2 id="ce-que-fait-jobboost" className="text-3xl font-bold text-gray-900 mt-16 mb-5">
              Ce que fait JobBoost pour votre CV Chargé RH
            </h2>
            <p className="text-gray-700 leading-8 mb-6 text-lg">
            ...
            <p className="text-gray-700 leading-8 mb-6 text-lg">
              JobBoost analyse la correspondance entre votre CV et une offre d&apos;emploi spécifique. Il identifie les mots-clés présents dans l&apos;offre qui manquent dans votre CV, ceux que le recruteur tapera dans son ATS pour trouver le bon profil RH.
            </p>
            <p className="text-gray-700 leading-8 mb-6 text-lg">
