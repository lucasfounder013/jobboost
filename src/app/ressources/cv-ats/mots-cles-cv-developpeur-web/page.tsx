...
export const metadata = {
  title: "Mots-clés CV Développeur Web : liste complète 2026 | Rivjob",
  description:
  ...
  ...ogMeta(
    "Mots-clés CV Développeur Web : liste complète 2026 | Rivjob",
    "Découvrez les 30+ mots-clés indispensables pour un CV Développeur Web qui passe les filtres ATS en 2026. Liste complète par catégorie + exemples.",
    "/ressources/cv-ats/mots-cles-cv-developpeur-web"
  ),
};
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      <main className="flex-1 max-w-6xl mx-auto w-full px-6 py-12">
        ...
        <ArticleJsonLd
          titre="Mots-clés CV Développeur Web : liste complète 2026 | Rivjob"
