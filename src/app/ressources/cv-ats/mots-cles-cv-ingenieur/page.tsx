...
export const metadata = {
  title: "Mots-clés CV Ingénieur : liste complète 2026 | JobBoost",
  description:
  ...
  ...ogMeta(
    "Mots-clés CV Ingénieur : liste complète 2026 | JobBoost",
    "Découvrez les 30+ mots-clés indispensables pour un CV Ingénieur qui passe les filtres ATS en 2026. Liste complète par catégorie + exemples.",
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      <main className="flex-1 max-w-6xl mx-auto w-full px-6 py-12">
        ...
        <ArticleJsonLd
          titre="Mots-clés CV Ingénieur : liste complète 2026 | JobBoost"
