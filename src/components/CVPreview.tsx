...
export default function CVPreview({ cv, showHighlights = false, fluid = false, ordreSections }: Props) {
  const contactItems = [
    cv.contact.email,
  ...
  function rendreSection(id: SectionId): React.ReactNode {
    switch (id) {
      case "experiences":
        ...
        return (
          <Section key="experiences" titre="EXPÉRIENCE PROFESSIONNELLE">
      ...
      case "formation":
        ...
        return (
          <Section key="formation" titre="FORMATION">
      ...
      case "competences":
        ...
        return (
          <Section key="competences" titre="COMPÉTENCES">
      ...
      case "projets":
        ...
        return (
          <Section key="projets" titre="PROJETS">
            {cv.projets.map((p, i) => (
              <div key={i} className={i > 0 ? "mt-3" : ""}>
      ...
      case "certifications":
        ...
        return (
          <Section key="certifications" titre="CERTIFICATIONS">
