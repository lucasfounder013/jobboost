    ...
    >
      ...
      {cv.competences && (
        ...
        <Section titre="COMPÉTENCES">
          {cv.competences.techniques && cv.competences.techniques.length > 0 && (
            <div className="mb-1">
          ...
          {cv.competences.langues && cv.competences.langues.length > 0 && (
            <div className="mb-1">
          ...
          {cv.competences.autres && cv.competences.autres.length > 0 && (
            <div className="mb-1">
